...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_Up ), sendMessage NextLayout)
    ...
    -- Suspend display
    , ((modm .|. controlMask, xK_q     ), spawn "systemctl suspend")
    ...
    , ((controlMask, xK_F7 ), spawn ("echo TODO: lower volume | xmessage -file -"))
    , ((controlMask, xK_F8 ), spawn ("echo TODO: raise volume | xmessage -file -"))
    ]
    ++
...
--
main = do
  xmproc <- spawnPipe "xmobar -x 0 /home/wbbradley/.config/xmobar/xmobar.config"
